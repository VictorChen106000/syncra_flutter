...
class ApplicationDetailSheet extends ConsumerStatefulWidget {
  ...
  static Future<void> show(BuildContext context, TrackedApplication app) {
    return showModalBottomSheet<void>(
      ...
      // Present from the root navigator so the sheet sits above the shell's
      // floating bottom nav — otherwise the nav overlaps the sheet's footer.
      ...
      children: [
        ...
        _ActionRow(
          ...
          trailing: Switch.adaptive(
            ...
            // ON = lime track + white thumb. The old all-ink thumb vanished
            // against the sheet's dark background.
